...
import xyz.zzzxb.tofu.common.exception.ParamException;
import xyz.zzzxb.tofu.common.exception.ThrowExceptionFun;
...
public final class CheckParamUtils {
    ...
    public static ThrowExceptionFun isTrue(boolean bool) {
        return (errorMsg, args) -> { if (bool) throw new ParamException(StringUtils.format(errorMsg, args)); };
    }
}
